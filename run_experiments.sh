...
python run_model.py --WB_project_name "GAMs-synt_data_phase1" --featureNN_arch_phase1 'single_to_multi_output' --hierarch_net 0 --featureNN_arch_phase1 'single_to_multi_output' --batch_size 1024 --lr_scheduler 'StepLR' --l2_lambda_phase1 1e-6
...
# python run_model.py --WB_project_name "Hirarchial_GAMs-synt_data" --featureNN_arch_phase1 'single_to_multi_output' --featureNN_arch_phase2 'parallel_single_output' --learning_rate 0.001 --epochs 1000 --first_hidden_dim_phase1 64 --hidden_dim_phase1 64 32 --first_activate_layer_phase1 "ReLU" --hidden_activate_layer_phase1 "ReLU" --first_hidden_dim_phase2 128 --hidden_dim_phase2 128 64 --first_activate_layer_phase2 "LipschitzMonotonic" --hidden_activate_layer_phase2 "LipschitzMonotonic"
