...
python run_model.py --WB_project_name "Hirarchial_GAMs-synt_data" --num_exp 10000 --epochs 300 --featureNN_arch_phase1 'single_to_multi_output' --featureNN_arch_phase2 'parallel_single_output' --first_hidden_dim_phase1 64 --hidden_dim_phase1 64 32 --first_activate_layer_phase1 "ReLU" --hidden_activate_layer_phase1 "ReLU" --first_hidden_dim_phase2 64 --hidden_dim_phase2 64 32 --first_activate_layer_phase2 "ReLU" --hidden_activate_layer_phase2 "ReLU" --batch_size 32 --monotonicity_lambda_phase2 0.001 --lr_scheduler 'CosineAnnealingLR' --l1_lambda_phase1 1e-9
